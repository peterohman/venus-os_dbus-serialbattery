	...
	GradientListView {
		model: ObjectModel {
					...
					Row {
						...
						Column {
							...
							QuantityLabel {
								...
								unit: VenusOS.Units_Volt_DC
								precision: 3
								valueColor: (chargeLimitationItem.isValid && chargeLimitationItem.value.indexOf("Cell Voltage") !== -1)
									|| (dischargeLimitationItem.isValid && dischargeLimitationItem.value.indexOf("Cell Voltage") !== -1)
						...
						Column {
							...
							QuantityLabel {
								...
								precision: 3
								valueColor: (chargeLimitationItem.isValid && chargeLimitationItem.value.indexOf("SoC") !== -1)
									|| (dischargeLimitationItem.isValid && dischargeLimitationItem.value.indexOf("SoC") !== -1)
									? "#BF4845" : Theme.color_font_primary
								font.pixelSize: 22
							}
					...
					Row {
						...
						Column {
							...
							QuantityLabel {
								...
								precision: 1
								valueColor: (chargeLimitationItem.isValid && chargeLimitationItem.value.indexOf("Temp") !== -1)
									|| (dischargeLimitationItem.isValid && dischargeLimitationItem.value.indexOf("Temp") !== -1)
									? "#BF4845" : Theme.color_font_primary
								font.pixelSize: 22
							}
						...
						Column {
							...
							QuantityLabel {
								...
								unit: Global.systemSettings.temperatureUnit
								precision: 1
								valueColor: (chargeLimitationItem.isValid && chargeLimitationItem.value.indexOf("MOSFET") !== -1)
									|| (dischargeLimitationItem.isValid && dischargeLimitationItem.value.indexOf("MOSFET") !== -1)
									? "#BF4845" : Theme.color_font_primary
								font.pixelSize: 22
							}
			...
			ListQuantityGroup {
				...
				textModel: [
					{ value: chargeModeItem.value },
					{ value: customDataObject.value },
					{ value: maxChargeVoltageItem.value, unit: VenusOS.Units_Volt_DC }
				]
				allowed: maxChargeCellVoltageItem.isValid

				QtObject {
					id: customDataObject
					property string value: maxChargeCellVoltageItem.isValid ? maxChargeCellVoltageItem.value.toFixed(3) + "V/cell" : "--"
				}
				VeQuickItem {
			...
			ListQuantityGroup {
				...
				text: qsTrId("batteryparameters_charge_voltage_limit_cvl")
				textModel: [
					{ value: chargeModeItem.value, defaultValue: "--" },
					{ value: maxChargeVoltageItem.value, unit: VenusOS.Units_Volt_DC }
				]
				allowed: !chargeLimitationFullItem.visible
			}
			...
			ListQuantityGroup {
				...
				textModel: [
					{ value: chargeLimitationItem.value, defaultValue: "--" },
					{ value: maxChargeCurrentItem.value, unit: VenusOS.Units_Amp }
				]
			...
			ListQuantityGroup {
				...
				textModel: [
					{ value: dischargeLimitationItem.value, defaultValue: "--" },
					{ value: maxDischargeCurrentItem.value, unit: VenusOS.Units_Amp }
				]
			...
			ListItem {
				...
				text: "Allow to"
				allowed: allowToChargeItem.isValid || allowToDischargeItem.isValid || allowToBalanceItem.isValid
				content.children: [
					Row {
						...
						Column {
							...
							Label {
								width: parent.width
								horizontalAlignment: Text.AlignHCenter
								text: CommonWords.yesOrNo(allowToChargeItem.value)
								color: allowToChargeItem.value === 0 ? "#BF4845" : Theme.color_font_primary
								font.pixelSize: 22
							}
						...
						Column {
							...
							Label {
								width: parent.width
								horizontalAlignment: Text.AlignHCenter
								text: CommonWords.yesOrNo(allowToDischargeItem.value)
								color: allowToDischargeItem.value === 0 ? "#BF4845" : Theme.color_font_primary
								font.pixelSize: 22
							}
						...
						Column {
							...
							Label {
								width: parent.width
								horizontalAlignment: Text.AlignHCenter
								text: CommonWords.yesOrNo(allowToBalanceItem.value)
								color: allowToBalanceItem.value === 0 ? "#BF4845" : Theme.color_font_primary
								font.pixelSize: 22
							}
			...
			ListTextItem {
				...
				allowed: secondaryLabel.text !== ""
			}

			ListLabel {
				text: "Driver Debug Data"
                allowed: chargeModeDebug.isValid
			}
			...
			ListItem {
				...
				allowed: chargeModeDebugFloat.isValid
			}
			...
			ListItem {
				...
				allowed: chargeModeDebugBulk.isValid
			}
