...
class DbusHelper:
    ...
    def Log_Data(self):
        ...
        logger.debug("GetTemp:   " + str(self.battery.get_temperature()))
        ...
        #        logger.debug("mintemp:   " + str(self.battery.get_min_temperature()))
        #        logger.debug("maxtemp:   " + str(self.battery.get_max_temperature()))
        logger.debug("mos_temp:      " + str(self.battery.temperature_mos))
        logger.debug("temperature_1: " + str(self.battery.temperature_1))
        logger.debug("temperature_2: " + str(self.battery.temperature_2))
        logger.debug("temperature_3: " + str(self.battery.temperature_3))
        logger.debug("temperature_4: " + str(self.battery.temperature_4))
