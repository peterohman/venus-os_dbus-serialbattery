...
# NOTES
# Added by https://github.com/JoshuaDodds
# https://github.com/mr-manuel/venus-os_dbus-serialbattery/pull/168
#
# TODO
...
class KS48100(Battery):
    def __init__(self, port, baud, address):
        super(KS48100, self).__init__(port, baud, address)
    ...
    def get_settings(self):
        ...
        if not result:
            # TROUBLESHOOTING for no reply errors
    ...
    def probe(self, ser, cid1=b"\x42", cid2=b"\x47"):
        result = False
